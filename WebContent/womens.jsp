...
<body>
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="women.html">Women's
					Clothing</a></li>
		...
		<div class="container">
			<div class="row my-sm-5">
							...
							<ul class="slides">
								<li data-thumb="images/mff1.jpg">
									<div class="thumb-image">
										<img src="images/mff1.jpg" data-imagezoom="true" alt=" "
											class="img-fluid">
									</div>
								</li>
								<li data-thumb="images/mff2.jpg">
									<div class="thumb-image">
										<img src="images/mff2.jpg" data-imagezoom="true" alt=" "
											class="img-fluid">
									</div>
								</li>
								<li data-thumb="images/mff3.jpg">
									<div class="thumb-image">
										<img src="images/mff3.jpg" data-imagezoom="true" alt=" "
											class="img-fluid">
									</div>
								</li>
							</ul>
				...
				<div
					...
					<h3>Harpa Casual 3/4th Sleeve Floral Print Women's Multicolor
						Top</h3>
					<div class="caption">
						...
						<div class="chr single-item single_page_b">
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart"> <input
									...
									type="hidden" name="hub_item" value="Floral Print Women's Top">
			...
			<div class="new_arrivals">
				...
				<div class="card-group my-5">
					...
					<div class="card product-men p-3">
						...
						<div class="card-footer d-flex justify-content-end">
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart"> <input
									type="hidden" name="add" value="1"> <input
									type="hidden" name="hub_item" value="Self Design Women's Tunic">
					...
					<div class="card product-men p-3">
						...
						<div class="card-footer d-flex justify-content-end">
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart"> <input
									type="hidden" name="add" value="1"> <input
									type="hidden" name="hub_item" value="Embroidered Women's Tunic">
					...
					<div class="card product-men p-3">
						...
						<!-- card body -->
						<div class="card-body  py-3 px-2">
							<h5 class="card-title text-capitalize">Popnetic Casual Full
								Sleeve Top</h5>
							<div class="card-text d-flex justify-content-between">
