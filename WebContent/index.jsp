			...
			<div id="clothing-nav-content" class="tab-content py-sm-5">
				<div role="tabpanel" class="tab-pane fade show active" id="women"
					...
					<div id="owl-demo" class="owl-carousel text-center">
						<%
							ArrayList<ChiTietSanPham> cardsDataWomen = ChiTietSanPhamDAO.getCardsData(8);
						%>
						<%
							for (int i = 0; i < cardsDataWomen.size(); i++) {
						%>
						...
						<div class="item">
							...
							<div class="card product-men p-3">
								<div class="men-thumb-item">
									<img src=<%=cardsDataWomen.get(i).getHinhAnh()%> alt="img"
										class="card-img-top">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href=<%=cardsDataWomen.get(i).getMaSanPham()%>
								...
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize"><%=cardsDataWomen.get(i).getTenSanPham()%></h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold"><%=cardsDataWomen.get(i).getGiaGiam()%></p>
										<p class="line-through"><%=cardsDataWomen.get(i).getGia()%></p>
									</div>
								</div>
								<!-- card footer -->
								<div class="card-footer d-flex justify-content-end">
									<form action="Card" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											...
											<input
											type="hidden" name="id"
											value=<%=cardsDataWomen.get(i).getMaSanPham()%>>
											<input
											type="hidden" name="hub_item"
											value="<%=cardsDataWomen.get(i).getTenSanPham()%>"> <input
											type="hidden" name="amount" value=<%=cardsDataWomen.get(i).getGiaGiam()%>>
				...
				<div role="tabpanel" class="tab-pane fade" id="men"
					...
					<div id="owl-demo1" class="owl-carousel text-center">
						<%
							ArrayList<ChiTietSanPham> cardsDataMen = ChiTietSanPhamDAO.getCardsData(5);
						%>
						<%
							for (int i = 0; i < cardsDataMen.size(); i++) {
						%>
						...
						<div class="item">
							...
							<div class="card product-men p-3">
								<div class="men-thumb-item">
									<img src=<%=cardsDataMen.get(i).getHinhAnh()%> alt="img"
										class="card-img-top">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href=<%=cardsDataMen.get(i).getMaSanPham()%>
												class="link-product-add-cart">Quick View</a>
										</div>
									</div>
								</div>
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize"><%=cardsDataMen.get(i).getTenSanPham()%></h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold"><%=cardsDataMen.get(i).getGiaGiam()%></p>
										<p class="line-through"><%=cardsDataMen.get(i).getGia()%></p>
									</div>
								</div>
								<!-- card footer -->
								<div class="card-footer d-flex justify-content-end">
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											...
											<input
											type="hidden" name="id"
											value=<%=cardsDataMen.get(i).getMaSanPham()%>>
											 <input
											type="hidden" name="hub_item"
											value=<%=cardsDataMen.get(i).getTenSanPham()%>> <input
											type="hidden" name="amount" value=<%=cardsDataMen.get(i).getGiaGiam()%>>
										<button type="submit" class="hub-cart phub-cart btn">
...
<!-- 								card body -->
<!-- 								<div class="card-body  py-3 px-2"> -->
<!-- 									<h5 class="card-title text-capitalize">Solid Formal Brown -->
<!-- 										Shirt</h5> -->
<!-- 									<div class="card-text d-flex justify-content-between"> -->
...
<!-- 											type="hidden" name="hub_item" -->
<!-- 											value="Solid Formal Brown Shirt"> <input -->
					...
					<div id="owl-demo2" class="owl-carousel text-center">
						<div class="item">
							...
							<div class="card product-men p-3">
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Midi/Knee Length
										Casual Dress</h5>
									<div class="card-text d-flex justify-content-between">
								...
								<div class="card-footer d-flex justify-content-end">
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="hub_item"
											value="Midi/Knee Length Casual Dress"> <input
								...
								<div class="card-footer d-flex justify-content-end">
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="hub_item"
											value="Midi/Knee Length Party Dress"> <input
						...
						<div class="item">
							...
							<div class="card product-men p-3 out_w3">
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Girls Party Top and
										Skirt Set</h5>
									<div class="card-text d-flex justify-content-between">
						...
						<div class="item">
							...
							<div class="card product-men p-3">
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Girl's Full Length
										Party Dress</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">$20.00</p>
								...
								<div class="card-footer d-flex justify-content-end">
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="hub_item" value="Full Length Party Dress">
								...
								<div class="card-footer d-flex justify-content-end">
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											...
											type="hidden" name="hub_item"
											value="Midi/Knee Length Party Dress"> <input
											type="hidden" name="amount" value="18.00">
										<button type="submit" class="hub-cart phub-cart btn">
											<i class="fa fa-cart-plus" aria-hidden="true"></i>
										</button>
										<a href="#" data-toggle="modal" data-target="#myModal1"></a>
					...
					<div id="owl-demo3" class="owl-carousel text-center">
						<div class="item">
							...
							<div class="card product-men p-3">
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Shirt, Waistcoat
										and Pant Set</h5>
									<div class="card-text d-flex justify-content-between">
								...
								<div class="card-footer d-flex justify-content-end">
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="hub_item"
											value="Shirt, Waistcoat and Pant Set"> <input
											type="hidden" name="amount" value="21.00">
										<button type="submit" class="hub-cart phub-cart btn">
											<i class="fa fa-cart-plus" aria-hidden="true"></i>
										</button>
										<a href="#" data-toggle="modal" data-target="#myModal1"></a>
						...
						<div class="item">
							...
							<div class="card product-men p-3">
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Festive Kurta and
										Pyjama Set</h5>
									<div class="card-text d-flex justify-content-between">
								...
								<div class="card-footer d-flex justify-content-end">
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="hub_item"
											value="Festive Kurta and Pyjama Set"> <input
						...
						<div class="item">
							...
							<div class="card product-men p-3">
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Boys Casual Shirt
										and Jeans</h5>
									<div class="card-text d-flex justify-content-between">
								...
								<div class="card-footer d-flex justify-content-end">
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="hub_item"
											value="Boys Casual Shirt and Jeans"> <input
											type="hidden" name="amount" value="24.99">
										<button type="submit" class="hub-cart phub-cart btn">
											<i class="fa fa-cart-plus" aria-hidden="true"></i>
										</button>
						...
						<div class="item">
							...
							<div class="card product-men p-3 out_w3">
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Casual Blazer,Shirt
										and Trouser Set</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">$18.00</p>
						...
						<div class="item">
							...
							<div class="card product-men p-3">
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Dungaree Casual
										Solid Denim</h5>
									<div class="card-text d-flex justify-content-between">
										<p class="text-dark font-weight-bold">$19.99</p>
										<p class="line-through">$24.99</p>
								...
								<div class="card-footer d-flex justify-content-end">
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="hub_item"
											value="Dungaree Casual Solid Denim"> <input
											type="hidden" name="amount" value="19.99">
										<button type="submit" class="hub-cart phub-cart btn">
											<i class="fa fa-cart-plus" aria-hidden="true"></i>
										</button>
						...
						<div class="item">
							...
							<div class="card product-men p-3">
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Boy's Casual Blue
										T-Shirt</h5>
									<div class="card-text d-flex justify-content-between">
								...
								<div class="card-footer d-flex justify-content-end">
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="hub_item"
											value="Boy's Casual Blue T-Shirt"> <input
						...
						<div class="item">
							...
							<div class="card product-men p-3">
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Boy's Casual Grey
										T-Shirt</h5>
									<div class="card-text d-flex justify-content-between">
								...
								<div class="card-footer d-flex justify-content-end">
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="hub_item"
											value="Boy's Casual Grey T-Shirt"> <input
						...
						<div class="item">
							...
							<div class="card product-men p-3">
								...
								<!-- card body -->
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize">Casual Shirt and
										Denim Jeans</h5>
									<div class="card-text d-flex justify-content-between">
								...
								<div class="card-footer d-flex justify-content-end">
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="hub_item"
											value="Casual Shirt and Denim Jeans"> <input
											type="hidden" name="amount" value="15.99">
										<button type="submit" class="hub-cart phub-cart btn">
											<i class="fa fa-cart-plus" aria-hidden="true"></i>
										</button>
										<a href="#" data-toggle="modal" data-target="#myModal1"></a>
